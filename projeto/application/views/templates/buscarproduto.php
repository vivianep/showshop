...
<html>
  <head>
    <meta charset="UTF-8">
    <title>ShowShop | Buscar Produto</title>
      ...
      <header class="main-header">               
        <nav class="navbar navbar-static-top">
          ...
          <div class="navbar-header">
            <a href="<?php echo base_url('index.php/shop');?>" class="navbar-brand"><b>Show</b>Shop</a>
          ...
          <div class="collapse navbar-collapse" id="navbar-collapse">
            ...
            <form action="<?php echo base_url('index.php/produto/buscar'); ?>" class="navbar-form navbar-left" role="search">
              <div class="form-group">
                <input type="text" name="termo" class="form-control" id="navbar-search-input" placeholder="Buscar Outro Produto"/>
              </div>
            </form>
