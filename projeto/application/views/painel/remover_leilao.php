	...
	<section class="content">
		<div class="col-md-9-edit">
			<div class="box box-primary">
				...
				<div class="box-body">
					<form role="form" method="post" action="<?php echo base_url('index.php/leilao/buscar_leilao2/'); ?>">
					...
					<div id="invisible-table">
						<div class="box-header">
						<h3 class="box-title">Tabela de Leilões</h3>
					</div><!-- /.box-header -->
						...
						<tbody>
							<?php foreach ($query->result() as $row){ ?>
								<tr>								   
									...
									<td>
										<center>
											<form role="form" accept-charset="utf-8" action="<?php echo base_url('index.php/leilao/deletar_dados/'); ?>" method="POST">
